...
#ruta_datos <- file.choose() #busca laruta de los datos
#print(ruta_datos) #presenta la ruta de los datos

#leer data inicial 
df <- read.csv("C:\\Users\\NANCY\\Documents\\datos_viñedo\\datos_vinedo_simulado.csv")
...
write.csv(df_final, "C:\\Users\\NANCY\\Documents\\datos_viñedo\\datos_vinedo_tratados1.csv", row.names = FALSE)
